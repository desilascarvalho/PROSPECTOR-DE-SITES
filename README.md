...
| `/publicar` | Publica na hospedagem SOZINHO (publicador automático, sem cPanel) + página-capa da proposta + HTTPS validado |
...
Claude Cowork · extensão Claude in Chrome · conectores Gmail e Google Drive · hospedagem com FTP/cPanel (HostGator, Locaweb, etc.) · Python (para o dashboard e o publicador) · Windows ou Mac.
